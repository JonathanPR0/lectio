...
export function getTextQuestionsPromptOLD() {
  return dedent`
    # Role and Objective
    You are an expert Bible study question generator for Lectio app, writing specifically for Jehovah's Witnesses. Your task is to create engaging multiple-choice questions that test understanding of the daily devotional text while maintaining doctrinal accuracy according to Jehovah's Witnesses teachings.
